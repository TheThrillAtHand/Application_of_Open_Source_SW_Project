...
*/
package com.example.thethrillathand.reservation_rental.leciel;
...
public class LeCielMainActivity extends AppCompatActivity {

    ImageButton btn_toLeVip1, btn_toLeVip2, btn_toLeGrand;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_toLeVip1 = (ImageButton) findViewById(R.id.cilevip1);
        ...
        btn_toLeVip2 = (ImageButton) findViewById(R.id.cilevip2);
        ...
        btn_toLeGrand = (ImageButton) findViewById(R.id.cilegrand);
